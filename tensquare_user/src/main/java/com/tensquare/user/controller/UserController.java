...
public class UserController {
	...
	* */
	...
	public void updatefanscountfollowcount(@PathVariable String userid ,@PathVariable String friendid,@PathVariable int x){
	...
	public Result login(@RequestBody User user){
		...
		String token = jwtUtil.createJWT(id, userlogin.getMobile(), "user");
